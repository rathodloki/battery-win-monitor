...
.DESCRIPTION
    ...
    Uses: Full-screen HD overlay banner (topmost, Win11 shadow), TTS speech, system tray balloon.
.NOTES
    Author: Antigravity
    Date: 2026-02-25
#>
...
# Custom UI + Native Win11 Shadow. Matches test-battery_monitor.ps1 design.
# ─────────────────────────────────────────────────────────────────────────────
$bannerScript = {
...
"@
    ...
    # ── Battery icon — Redesigned with rounded paths ───────────────────────────
    $dispW = 140; $dispH = 80
